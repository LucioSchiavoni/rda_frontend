...
const ButtonDownload: React.FC<ButtonDownloadProps> = ({ fileId, nameFile }) => {
    ...
    return (
         <button onClick={handleDownload} className="flex items-center px-4 py-2 text-sm font-medium  mb-1 transition-colors duration-200 sm:text-base sm:px-6  rounded-md dark:hover:bg-neutral-800 bg-gray-100 dark:bg-neutral-900  border dark:border-neutral-800 dark:text-white gap-x-3 hover:bg-gray-200">

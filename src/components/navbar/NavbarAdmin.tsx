...
const NavbarAdmin = () => {
  ...
  return (
    <aside className="flex flex-col fixed items-center  w-16  min-h-screen py-8 overflow-y-auto bg-white border-r rtl:border-l rtl:border-r-0 dark:bg-neutral-900 dark:border-neutral-800">
 ...
 <Link to='/auth' className="p-1.5 flex justify-center  text-gray-700 focus:outline-nones transition-colors duration-200 rounded-lg dark:text-gray-200 dark:hover:bg-gray-800 hover:bg-gray-100">
        ...
        <Tooltip label="Crear post" aria-label="A tooltip">
        ...
        <span className="text-3xl "><IoCreateOutline /></span> 
        </Link>
        </Tooltip>

        <Tooltip label="Lista de usuarios" aria-label="A tooltip">
        <Link to='/auth' >
            <span className="flex justify-center text-3xl p-1.5 rounded-md hover:bg-gray-200 text-gray-700 
            ...
            <Tooltip label="Crear nuevo usuario" aria-label="A tooltip">
                <Link to='/register' >
                    <span className="text-2xl flex justify-center text-gray-700 dark:hover:bg-neutral-800 dark:text-white hover:bg-gray-200 p-1.5 rounded-md">
                        <RiUserAddLine />
                    </span>
    ...
    <Tooltip label="Cambiar contraseña" aria-label="A tooltip">
<Link to='/password' className="p-1.5 ml-1 text-gray-700 focus:outline-nones transition-colors duration-200 rounded-lg dark:text-gray-200 dark:hover:bg-gray-800 hover:bg-gray-100">
           <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="w-6 h-6">
